...
macro(enable_sanitizers SANITIZERS)
  ...
  # Also set linker flags for shared libraries (needed for macOS to properly link ASAN runtime)
  set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${SAN_COMPILE_FLAGS}")
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${SAN_COMPILE_FLAGS}")
  message(STATUS "Sanitizers linker flags: ${SAN_COMPILE_FLAGS}")
endmacro()
